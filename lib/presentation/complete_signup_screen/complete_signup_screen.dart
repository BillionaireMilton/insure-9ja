import '../complete_signup_screen/widgets/listellipsefiftynine_item_widget.dart';
                ...
                child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              padding:
                                  getPadding(left: 19, top: 17, right: 116),
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return ListellipsefiftynineItemWidget();
                                  }))
                        ]))),
            bottomNavigationBar: CustomButton(
                height: getVerticalSize(56),
                text: "Sign Up",
                margin: getMargin(left: 24, right: 24, bottom: 56),
